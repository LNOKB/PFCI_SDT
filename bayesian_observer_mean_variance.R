...
for (k in 1:length(subs)){
  ...
  ggsave(file = file.path("SubPlotBar", paste0("bar_graph_bayes_both_", subs[k], ".png")),
  ...
  plot_sdt_distributions_ideal_sub <- function(means, sds, attention_levels, image_types, colors) {
    ...
    ggsave(file = file.path("SubPlotDistribution", paste0("Distribution_bayes_both_", subs[k], ".png")),
